...
public class MySignInPanel extends SignInPanel
{
	...
	/** Log. */
	private static final Logger log = LoggerFactory.getLogger(MySignInPanel.class);
	...
	{
		return NewAuthenticatedWebSession.get().signIn(username, password);
	}
	...
	{
		return NewAuthenticatedWebSession.get().isSignedIn();
	}
...
//	 * Sign in form.
//	 */
//	public final class SignInForm extends StatelessForm<MySignInPanel>
//	{
//		private static final long serialVersionUID = 1L;
//
//		/**
...
//			super(id);
//
//			setModel(new CompoundPropertyModel<MySignInPanel>(MySignInPanel.this));
//
